...
from tensorflow.keras.layers import Dense, Dropout, Input, Activation, PReLU
...
def tfidf_models(x_train, y_train, x_test, y_test):
    ...
    model.compile(
        loss="kullback_leibler_divergence",  # originally, we tested a variety of different loss fns,
...
if __name__ == "__main__":
    ...
    best_run, best_model = optim.minimize(
        model=tfidf_models, data=data, algo=tpe.suggest, max_evals=500, trials=Trials()
    )
