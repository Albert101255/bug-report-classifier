...
export const ReviewQueue: React.FC = () => {
  ...
  const handleOverride = async (id: string) => {
    ...
    showToast(
      `Corrected team to '${selectedTeam}' and logged for retraining audit trail`,
    );
    setItems((prev) => prev.filter((i) => i.id !== id));
  };
  ...
  return (
    <div>
      ...
      <div className="page-header">
        <div>
          ...
          <p className="page-subtitle">
            Inspect low-confidence predictions (Uncertainty &gt; 0.05) and log
            human corrections
          </p>
        </div>
      </div>
      ...
      <div className="card">
        ...
        {items.length === 0 ? (
          <div
            style={{ color: '#64748b', padding: '3rem 0', textAlign: 'center' }}
          >
            <Check
              size={48}
              style={{ opacity: 0.3, marginBottom: '0.5rem', color: '#34d399' }}
            />
            ...
            >
              All predictions have been auto-assigned or resolved.
            </p>
          </div>
        ) : (
          <div
              ...
              >
                ...
                >
                  <div>
                    <span className={`badge badge-${item.confidence_level}`}>
                      {item.confidence_level} UNCERTAINTY
                    </span>
                    <h3
                      style={{
                        fontSize: '1.05rem',
                ...
                >
                  <div style={{ flex: 1 }}>
                    ...
                    <div
                      style={{ fontWeight: 700, color: 'var(--accent-indigo)' }}
                    >
                      {item.predicted_team}
                    </div>
                  </div>
                ...
                >
                  ...
                  <button
                    ...
                    onClick={() => handleApprove(item.id, item.predicted_team)}
                  >
