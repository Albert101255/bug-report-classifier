...
export const Settings: React.FC = () => {
  ...
  const [compareText, setCompareText] = useState(
    'OAuth token validation failure on user login endpoint',
  );
  ...
  const handleCompare = async () => {
    ...
    showToast(
      'Evaluated side-by-side comparison across Model v1.0 vs Model v1.1!',
    );
  };
    ...
    <div>
      ...
      <div className="page-header">
        <div>
          ...
          <p className="page-subtitle">
            Configure uncertainty thresholds, compare model versions, and
            trigger retraining
          </p>
        </div>
      </div>
      ...
      >
        ...
        <div className="card">
          ...
          >
            <Sliders size={18} color="var(--accent-indigo)" /> Monte Carlo
            Confidence Cutoffs
          </h2>
          ...
          <div style={{ marginBottom: '1.5rem' }}>
            ...
            >
              <span>
                High Confidence Cutoff (Uncertainty &lt; {highThreshold})
              </span>
            ...
            <span style={{ fontSize: '0.75rem', color: '#64748b' }}>
              Predictions below this uncertainty are auto-assigned to team
              backlog.
            </span>
          </div>
          ...
          <div style={{ marginBottom: '1.5rem' }}>
            ...
            >
              <span>
                Low Confidence Cutoff (Uncertainty &gt; {lowThreshold})
              </span>
            ...
            />
            <span style={{ fontSize: '0.75rem', color: '#64748b' }}>
              Predictions above this uncertainty are routed to Human Review
              Queue.
            </span>
          </div>
          ...
          <button
            ...
            style={{ width: '100%' }}
            onClick={() =>
              showToast('Confidence thresholds updated successfully!')
            }
          >
        ...
        <div className="card">
          ...
          >
            <Cpu size={18} color="var(--accent-purple)" /> Retraining Pipeline &
            Model Info
          </h2>
          ...
          >
            ...
            >
              ...
              <strong style={{ color: 'var(--accent-indigo)' }}>
                {modelInfo?.model_version || 'v1.0-tfidf-mc'}
              </strong>
            </div>
            <div
              style={{
      ...
      <div className="card">
        ...
        >
          <GitCompare size={18} color="var(--accent-cyan)" /> Side-by-Side Model
        ...
        {compareResult && (
          ...
          >
            ...
            >
              ...
              >
                {compareResult.model_v1?.predicted_team}
              </h3>
              <div
                style={{
                  fontSize: '0.85rem',
              ...
              >
                Confidence:{' '}
                {(
                  (compareResult.model_v1?.confidence_score || 0.88) * 100
                ).toFixed(1)}
                %
              </div>
            </div>
            ...
            <div>
              <span style={{ fontSize: '0.75rem', color: '#94a3b8' }}>
                Active Learning Model (v1.1-retrained)
              </span>
              <h3
                style={{
                  fontSize: '1.1rem',
              ...
              >
                {compareResult.model_v1_retrained?.predicted_team}
              </h3>
              <div
                style={{
                  fontSize: '0.85rem',
              ...
              >
                Confidence:{' '}
                {(
                  (compareResult.model_v1_retrained?.confidence_score || 0.94) *
                  100
                ).toFixed(1)}
                %
              </div>
