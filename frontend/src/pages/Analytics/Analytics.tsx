...
export const Analytics: React.FC = () => {
  ...
  const teamChartData = Object.entries(data?.team_accuracy_breakdown || {}).map(
    ([team, acc]) => ({
      name: team.split(' ')[0],
      fullName: team,
      accuracy: acc,
      ...
      <div className="page-header">
        <div>
          ...
          <p className="page-subtitle">
            Accuracy metrics per team, prediction throughput, and human
            correction rate
          </p>
        </div>
      </div>
